...
pub struct Annotations {
    ...
    pub star_by_time: HashMap<Time, AnnotationDates>,
                ...
                } else if let Some(captures) = regex!(r"(?i)^(Except|Only) on (.*)").captures(annotation_text.as_ref())
                {
                    ...
                    match annotation_text {
                        ...
                        "** Except on Sep 18 & Oct 2" =>
                            self.star2.except.extend([schedule_year_date(Month::September, 18)?, schedule_year_date(Month::October, 2)?]),
                        "*** Except Sep 18 & Oct 2" =>
                            self.star3.except.extend([schedule_year_date(Month::September, 18)?, schedule_year_date(Month::October, 2)?]),
                        "** Only on April 14th" =>
                            self.star2.only.extend([schedule_year_date(Month::April, 14)?]),
                        "** Only on December 23 and December 30" |
                        "** Only on Dec 23 & 30" =>
                            self.star2.only.extend([schedule_year_date(Month::December, 23)?, schedule_year_date(Month::December, 30)?]),
                        ...
                        "** Only on Sep 18 & Oct 2" =>
                            self.star2.only.extend([schedule_year_date(Month::September, 18)?, schedule_year_date(Month::October, 2)?]),
